                            ...
                            <div class="wpem-event-date-type">
                                ...
                                if (!empty($start_date)) { ?>
                                    <div class="wpem-from-date">
                                        <div class="wpem-date"><?php echo esc_attr_e(date_i18n('d', strtotime($start_date))); ?></div>
                                        <div class="wpem-month"><?php echo esc_attr_e(date_i18n('M', strtotime($start_date))); ?></div>
                                    </div>
                                <?php } ?>
                            </div>
                        </div>
                ...
                <div class="wpem-event-infomation">
                        ...
                        <div class="wpem-event-date-type">
                            ...
                            if ($start_date != $end_date && !empty($end_date)) {  ?>
                                <div class="wpem-to-date">
                                    ...
                                    <div class="wpem-date"><?php echo esc_attr_e(date_i18n('d', strtotime($end_date))); ?></div>
                                    <div class="wpem-month"><?php echo esc_attr_e(date_i18n('M', strtotime($end_date))); ?></div>
                                </div>
                            <?php } ?>
                        </div>
                    </div>
                    ...
                    <div class="wpem-event-details">
                        ...
                        <div class="wpem-event-title">
                            <h3 class="wpem-heading-text"><?php echo esc_attr_e(get_the_title()); ?></h3>
                        </div>
                        ...
                        if (get_option('event_manager_enable_event_types') && get_event_type()) { ?>
                            <div class="wpem-event-type"><?php display_event_type_no_link(); ?></div>
                        <?php } 
